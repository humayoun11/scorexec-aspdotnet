...
using ScoringAppReact.Models.TokenAuth;
...
{
    public abstract class ScoringAppReactWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ScoringAppReactWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ScoringAppReactWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ScoringAppReactDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ScoringAppReactDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ScoringAppReactDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ScoringAppReactDbContext, Task<T>> func)
        {
            T result;
